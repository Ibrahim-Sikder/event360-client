...
const CustomerSupport = () => {
    return (
        ...
        <Container className="">
            ...
            <div>
                <h2 className="text-4xl font-bold"><span className="text-[#01DBF7]">24/7</span> Customer Support  </h2>
                <div className="flex items-center mt-8">
                  ...
                  <p className="z-[99] italic max-w-[50ch] leading-7 -ml-8">We were really thrilled with the steps the team took to hold our hands as first-time customers, and we really felt that level of support.</p>
                    </div>
                    <div className="mt-3">
                    <h5>Jhon Doe </h5>
